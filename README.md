...
This fork is intended for my personal usage focused on bilibili extractor fixes. Most of the changes is done by AI, mirroring the
approach of [Piliplus](https://github.com/bggRGjQaUbCoE/PiliPlus). This can't be upstreamed due to yt-dlp's contribution policy.

The license should be still Unlicense as long as it's applicable to AI slops lol.
...
- [**curl_cffi**](https://github.com/lexiforest/curl_cffi) (recommended) - Python binding for [curl-impersonate](https://github.com/lexiforest/curl-impersonate). Provides impersonation targets for Chrome, Edge and Safari. Licensed under [MIT](https://github.com/lexiforest/curl_cffi/blob/main/LICENSE)
  ...
  - Currently included in most builds _except_ `yt-dlp` (Unix zipimport binary) and `yt-dlp_x86` (Windows 32-bit)
...
Using one of the yearly compat option aliases will pin yt-dlp's default behavior to what it was at the _end_ of that calendar year.
